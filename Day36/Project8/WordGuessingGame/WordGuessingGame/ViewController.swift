...
class ViewController: UIViewController {
  ...
  override func loadView() {
    ...
    NSLayoutConstraint.activate([
      ...
      submit.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: -44),
      submit.heightAnchor.constraint(equalToConstant: 44),
      
      clear.topAnchor.constraint(equalTo: currentAnswer.bottomAnchor),
      clear.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: 44),
  ...
  @objc func submitTapped(_ sender: UIButton) {
    guard let answer = currentAnswer.text, let answerIndex = solutions.firstIndex(of: answer) else { return }
