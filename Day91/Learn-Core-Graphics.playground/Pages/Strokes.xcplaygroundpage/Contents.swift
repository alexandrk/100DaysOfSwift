...
let rendered = renderer.image { ctx in
  ...
  let smallCircle1 = CGRect(x: 0, y: 0, width: 200, height: 200)
  ctx.cgContext.addEllipse(in: smallCircle1)
  
  let smallCircle2 = CGRect(x: 800, y: 0, width: 200, height: 200)
  ctx.cgContext.addEllipse(in: smallCircle2)
  
  let smallCircle3 = CGRect(x: 0, y: 800, width: 200, height: 200)
  ctx.cgContext.addEllipse(in: smallCircle3)
  
  let smallCircle4 = CGRect(x: 800, y: 800, width: 200, height: 200)
