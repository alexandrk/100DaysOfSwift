...
let rendered = renderer.image { ctx in
  ...
  let borderRect = CGRect(x: 0, y: 0, width: 1000, height: 1000).insetBy(dx: 20, dy: 20)
  ctx.cgContext.stroke(borderRect, width: 10)

  let imageRect = CGRect(x: 0, y: 0, width: 1000, height: 1000).insetBy(dx: 30, dy: 30)
